...
const NOTIF_ICON_TYPE = new Object( {
  SUCCESS: 'done',
  ERROR: 'error_outline',
  INFO: 'info',
 ...
 const NOTIF_MESSEGAES = new Object( {
 ...
 const NOTIF_ALIGNMENT = new Object({
   TOP: 'top',
   BOTTOM: 'bottom',
   LEFT: 'left',
   RIGHT: 'right',
